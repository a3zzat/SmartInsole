...
xTaskCreate(Communication, (char*)"Communication",configMINIMAL_STACK_SIZE,NULL,2,NULL);

xTaskCreate(Piezo, (char*)"Piezo",configMINIMAL_STACK_SIZE,NULL,1,NULL);

xTaskCreate(Accelerometer, (char*)"Accelerometer",configMINIMAL_STACK_SIZE,NULL,3,NULL);
